...
namespace LWddd\baseCommandResolver;

class baseAdd extends \LWddd\ModelCommandResolver
{
    protected $command;
    ...
    {
        return new baseAdd($command);
    }
    
    public function resolve()
    {
        $valueObject = new \LWddd\ValueObject($this->command->getDataByKey('postArray'));
